 ...
 */
 ...
 // Chris Bolt - renamed wpro_xajaxResponse for compatibility with apps that alread have xajaxResponse in use - 18 Jan 08
class wpro_xajaxResponse
{
	/**#@+
	 * @access protected
	 */
	 ...
	 * 
	 */
	function wpro_xajaxResponse($sEncoding=XAJAX_DEFAULT_CHAR_ENCODING, $bOutputEntities=false)
	{
	...
	{
		if (is_a($mCommands, 'wpro_xajaxResponse')) {

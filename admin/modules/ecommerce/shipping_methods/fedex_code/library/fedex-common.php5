...
function getProperty($var){
	...
	if($var == 'shipaccount') Return '510087089';
	if($var == 'billaccount') Return '510087089';
	if($var == 'dutyaccount') Return '510087089';
	if($var == 'accounttovalidate') Return '510087089';
	if($var == 'meter') Return '118522729';
	if($var == 'key') Return 'Ye032FDUpecb5SHD';
	if($var == 'password') Return 'hga3Nj0vOqGrnbRtUpq2Mqti2';
	...
	if($var == 'account') Return '510087089';

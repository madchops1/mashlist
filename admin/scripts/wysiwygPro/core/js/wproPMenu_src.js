...
wproPMenu.prototype.showPMenu = function (node, width, height, posx, posy, type) {
	...
	//setTimeout("WPro.events.addEvent(document.body, 'mousedown', WPro.editors['"+this.editor+"'].closePMenuTimeout)", 200);
}
...
wproPMenu.prototype._removeEvents = function() {
	//WPro.events.removeEvent(document.body, 'mousedown', WPro.editors[this.editor].closePMenuTimeout);
}
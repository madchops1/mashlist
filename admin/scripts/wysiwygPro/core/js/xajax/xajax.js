...
catch(e){/* Chris Bolt, added auto switching to get */return this.call(sFunction, aArgs, xajaxDefinedGet);/*alert("Your browser does not appear to  support asynchronous requests using POST.");return false;*/}
}

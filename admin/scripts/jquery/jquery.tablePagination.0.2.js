 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<ul><li><span id='tablePagination_firstPage'> <img src='images/icons/left1_16.png' /> First</span></li>");
        htmlBuffer.push("<li><span id='tablePagination_prevPage'> <img src='images/icons/left_16.png' /> Previous</span></li>");
        //htmlBuffer.push(" Page" + currPageNumber + " of " + totalPages + " ");
        htmlBuffer.push("<li> Page <input id='tablePagination_currPage' type='input' style='background:#A9CBD7 ; color:#555; border:0px; font-size:12px;' DISABLED value='"+currPageNumber+"' size='1'>");
        htmlBuffer.push("of <span id='tablePagination_totalPages'>"+totalPages+"</span> </li>");
        htmlBuffer.push("<li><span id='tablePagination_nextPage'>Next <img src='images/icons/right_16.png' /> </span></li>");
        htmlBuffer.push("<li><span id='tablePagination_lastPage'>Last <img src='images/icons/right1_16.png' />  </span></li>");
        htmlBuffer.push("</ul></span>");
        htmlBuffer.push("</div>");

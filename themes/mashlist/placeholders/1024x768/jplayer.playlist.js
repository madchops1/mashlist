...
(function($, undefined) {
	...
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		this.cssSelector.album = this.cssSelector.cssSelectorAncestor + " .jp-albutm"; // Note that the text is written to the decendant li node.
		this.cssSelector.media_type = this.cssSelector.cssSelectorAncestor + " .jp-media-type"; // Note that the text is written to the decendant li node.
		this.cssSelector.media_title = this.cssSelector.cssSelectorAncestor + " .jp-media-title"; // Note that the text is written to the decendant li node.
		/* - end MD */
		...
		$(this.cssSelector.jPlayer).bind($.jPlayer.event.resize, function(event) {
			if(event.jPlayer.options.fullScreen) {
				...
				//$(self.cssSelector.title).hide(); // -kjs
			}
		});
		...
		if(!this.options.fullScreen) {
			//$(this.cssSelector.title).hide(); // -kjs
		}

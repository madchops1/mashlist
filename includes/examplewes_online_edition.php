 ...
 */
require_once ''.$_SETTINGS['DOC_ROOT'].'admin/modules/ecommerce/quickbooks/qboe/v1-5-3/QuickBooks.php';
...
$return = $API->qbxml('
		<CustomerQueryRq>
			<FullName>Karl Steltenpohl</FullName>

...
?>
<li><a class="Search <? if($_REQUEST['SUB'] == "EMAILS"){ ?> active <? } ?>" href="?VIEW=<?=$_GET['VIEW']?>&SUB=EMAILS">Automated Emails</a></li>
<li><a class="Add <? if($_REQUEST['SUB'] == "NEWEMAIL"){ ?> active <? } ?>" href="?VIEW=<?=$_GET['VIEW']?>&SUB=NEWEMAIL">New Email</a></li>

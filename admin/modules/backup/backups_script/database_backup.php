...
$VERBOSE = true;
$BACKUP_NAME = 'ksdvd1_mysql_backup_' . date('Y-m-d');
...
$EMAIL_SUBJECT = 'SQL Backup for KSDVD1 Server ' . date('Y-m-d') . ' at ' . date('H:i');
$EMAIL_ADDR = 'karl@webksd.com';
$ERROR_EMAIL = 'karl@webksd.com';
$ERROR_SUBJECT = 'KSDVD1 SQL BACKUP ERROR: ' . $EMAIL_SUBJECT;
...
if( file_exists( 'database_backup_config.php' ) ) {
	//require( $current_path.'/database_backup_config.php' );
	require( 'database_backup_config.php' );
} else {
